...
//    }
    ...
    {
        //我的推荐人
        $up_user_info = \app\models\User::findOne($this->user_model['fuid1']);
        return $this->render('index',[
            'user_model' => $this->user_model,
            'up_user_info' => $up_user_info,
        ]);
    }
     ...
     * 支付密码--设置
     * */
    public function actionRestPayPwdEmail()
    {
        if($this->request->isAjax){
            $php_input = $this->request->post();
            $this->user_model->scenario=\app\models\User::SCENARIO_REST_PAY_PWD_EMAIL;
            $result = $this->user_model->actionSave($php_input);
            return $this->asJson($result);

        }

        return $this->render('restPayPwdEmail',[
            'user_model' => $this->user_model,
        ]);
    }
    ...
    public function actionWithdrawDel()
    {
        ...
        try{
            $this->user_model->downWithdraw($id);
