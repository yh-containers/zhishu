<footer class="footer">
    <div class="footer_nav clearfix">
        ...
        <a href="<?=\yii\helpers\Url::to(['chat/index'])?>"  <?=$current_active=='chat/index'?'class="cur"':''?> ><i class="icon iconfont icon-xiaoxi"></i><span>聊天<?php if($chat_num){?><span class="red_dot"><?=$chat_num?></span><?php }?></span></a>
