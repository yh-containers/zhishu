...
<main class="main mgtop">
    <div class="chatroom">
        <div class="chatroom_nav">
            <ul class="clearfix">
                <li class="cur"><a href="chatroom.html"><span>全部会员</span></a></li>
                <li><a href="chatroom.html"><span>我的好友</span></a></li>
                <li><a href="chatroom.html"><span>陌生人</span></a></li>
                <li><a href="chatroom.html"><span>黑名单</span></a></li>
            </ul>
        </div>
        <div class="withdraw">
            <ul id="demo">
...
<script>
    var url = '<?=\yii\helpers\Url::to(['mine/show-list'])?>';
