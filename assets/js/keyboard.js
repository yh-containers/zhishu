    ...
    $.fn.KeyBoard = function (options) {
        ...
        return this.each(function () {
            ...
            if (defaults.type == "money") {
                defaults.show.html('<input type="password" class="keyboard-input-text input_ keyboard-password" disabled>');
            } else {
                defaults.show.append('<input type="password" class="keyboard-input-text input_ keyboard-password hidden" disabled>');
                for (var j = 1; j <= 6; j++) {
                    var str = '<input type="password" class="keyboard-input-text input_' + j + ' keyboard-money" disabled>'
